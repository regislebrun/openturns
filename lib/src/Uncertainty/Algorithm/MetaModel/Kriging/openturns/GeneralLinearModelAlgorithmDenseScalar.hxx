 ...
 *
 */
#ifndef OPENTURNS_GENERALLINEARMODELALGORITHMDENSESCALAR_HXX
#define OPENTURNS_GENERALLINEARMODELALGORITHMDENSESCALAR_HXX
...
/**
 * @class GeneralLinearModelAlgorithmDenseScalar
 *
 * The class building generalized linear model
 */

class OT_API GeneralLinearModelAlgorithmDenseScalar
...
public:
  ...
  /** Default constructor */
  GeneralLinearModelAlgorithmDenseScalar();

  /** Parameters constructor */
  GeneralLinearModelAlgorithmDenseScalar (const Sample & inputSample,
                               const Sample & outputSample,
                               const CovarianceModel & covarianceModel,
                               const Bool keepCholeskyFactor = ResourceMap::GetAsBool("GeneralLinearModelAlgorithmDenseScalar-KeepCovariance"));
  ...
  /** Virtual constructor */
  GeneralLinearModelAlgorithmDenseScalar * clone() const override;
...
protected:
  ...
  friend class KrigingAlgorithmDenseScalar;
...
private:
  ...
  public:
    ...
    ReducedLogLikelihoodEvaluation(GeneralLinearModelAlgorithmDenseScalar & algorithm)
  ...
  private:
    GeneralLinearModelAlgorithmDenseScalar & algorithm_;
