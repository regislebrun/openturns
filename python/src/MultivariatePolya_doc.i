...
The marginal distribution of a category is a beta-binomial
:math:`\mathrm{X_i} \sim \mathrm{BetaBinomial}(N, \alpha_i / c, (q - \alpha_i) / c)`
...
- ``MultivariatePolya-eta``, default :math:`1.0e-9`;
- ``MultivariatePolya-smallA``, default :math:`10.0`.
